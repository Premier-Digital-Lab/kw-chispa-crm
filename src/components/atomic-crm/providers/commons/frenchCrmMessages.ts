...
export const frenchCrmMessages = {
  resources: {
    ...
    contacts: {
      ...
      field_categories: {
        ...
        membership: "Adhésion",
        mc_address: "Adresse du Market Center",
      },
      fields: {
        first_name: "Prénom",
        last_name: "Nom",
        ...
        background: "Bio",
        has_newsletter: "Recevoir les e-mails KW CHISPA",
        sales_id: "Responsable de compte",
        cell_number: "Numéro de portable",
        market_center_name: "Nom du Market Center",
        market_center_team_leader: "Nom du Team Leader",
        market_center_tl_phone: "Téléphone du Team Leader",
        market_center_tl_email: "E-mail du Team Leader",
        agent_role: "Rôle de l'agent",
        mc_street_number: "Numéro de rue",
        mc_street_name: "Nom de la rue",
        ...
        cities_served: "Villes desservies",
        counties_served: "Comtés desservis",
        states_served: "États desservis",
        countries_served: "Pays desservis",
        membership_tier: "Niveau d'adhésion",
        join_date: "Date d'adhésion",
        member_status: "Statut d'adhésion",
      },
      action: {
  ...
  crm: {
    ...
    auth: {
      ...
      welcome_title: "Bienvenue sur KW CHISPA Central",
    },
    common: {
      activity: "Activité",
      added: "ajoutée",
    ...
    dashboard: {
      ...
      stepper: {
        install: "Installer KW CHISPA Central",
    ...
    profile: {
      inbound: {
        description:
          "Vous pouvez commencer à envoyer des e-mails vers l'adresse de réception de votre serveur, par exemple en l'ajoutant au champ %{field}. KW CHISPA Central traitera les e-mails et ajoutera des notes aux membres correspondants.",
