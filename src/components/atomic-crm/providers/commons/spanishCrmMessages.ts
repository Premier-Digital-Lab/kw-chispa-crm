...
export const spanishCrmMessages: PartialCrmMessages = {
  ...
  crm: {
    ...
    premier: {
      ...
      locked_message: "Este contenido está disponible únicamente para miembros Premier de KW CHISPA. Comunícate con tu administrador para actualizar tu membresía.",
